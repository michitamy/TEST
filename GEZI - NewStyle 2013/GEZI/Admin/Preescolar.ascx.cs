...
public partial class Admin_Preescolar : BaseUserControl
{
    ...
    protected void btnAceptar_Click(object sender, EventArgs e)
    {
        ...
        {
            PintaPanel(GetMessages(Mensaje.TipoMens.Error, "No pudo ser agregado correctamente. " + ex.Message, "Error. "));
        }
    }
    ...
    protected void CargarCaracteristicas()
    {
        ...
        txtCostoinsc.Text = ce.Costoinsc.Equals(-1) ? string.Empty : ce.Costoinsc.ToString();
        txtCostocolra.Text = ce.Costocolra.Equals(-1) ? string.Empty : ce.Costocolra.ToString();
