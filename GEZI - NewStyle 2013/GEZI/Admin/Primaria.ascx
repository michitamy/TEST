<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Primaria.ascx.cs" Inherits="Admin_Primaria" %>
...
<h1>
    Atributos para el nivel Primaria</h1>
...
<table>
    <tr>
        ...
        <td style="width: 80%">
            <small style="color: #CC0000;">*</small>sCuenta con examen de selección/diagnostico
            para el ingreso
        </td>
        <td>
...
<asp:Panel runat="server" ID="pnlGuardar" BackColor="#E4E4E4" BorderColor="#CCCCCC"
    ...
    <center>
        ...
        &nbsp;<asp:Button runat="server" ID="btnCancelar" Text="Cancelar" ToolTip="Cancelar inserción atributos."
            PostBackUrl="~/Admin/Inicio_Admin.aspx" />
</asp:Panel>
</center>
