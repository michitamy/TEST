<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Secundaria.ascx.cs" Inherits="Admin_Secundaria" %>
...
<h1>
    Atributos para el nivel Secundaria</h1>
...
<table>
    <tr>
        ...
        <td style="width: 80%">
            <small style="color: #CC0000;">*</small>Cuenta con examen de selección/diagnostico para el ingreso
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con curso de preparación para el ingreso
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con sistema de consulta de calificaciones por internet
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con su propio sistema de administración de clases por internet para que lo
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Su biblioteca cuenta con computadoras e internet
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con programa de formación pedagógica para sus docentes
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con programa de actualización disciplinaria para sus docentes
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con laboratorio de idiomas y con cuantos cuenta la Institución Educativa
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <small style="color: #CC0000;">*</small>Cuenta con laboratorio de computo y con cuantos cuenta la Institución Educativa
        </td>
        <td>
    ...
    <%--<tr>
        ...
        <td>
            <asp:TextBox runat="server" ID="txtEgresados" Text="" Width="100px" MaxLength="3"></asp:TextBox>
...
<asp:Panel runat="server" ID="pnlGuardar" BackColor="#E4E4E4" BorderColor="#CCCCCC"
    ...
    <center>
        <asp:Button runat="server" ID="btnGuardar" Text="Guardar" OnClick="btnAceptar_Click"
            ValidationGroup="validaCaractca"  ToolTip="Guardar atributos del plantel."/>
        &nbsp;<asp:Button runat="server" ID="btnCancelar" Text="Cancelar" PostBackUrl="~/Admin/Inicio_Admin.aspx" ToolTip="Cancelar inserción atributos." /></center>
</asp:Panel>
